            ...
            <div class="row gx-0 gy-4 g-md-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <a href="javascript:void(0);" class="d-block footer-link mb-3 pb-2"><img
                            src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/apple-icon.png"
                            alt="apple icon" /></a>
                    <a href="javascript:void(0);" class="d-block footer-link"><img
                            src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/google-play-icon.png"
