<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        ...
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Repository</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Repository</span>
        </li>
        ...
        @if (Auth::user()->role == 'admin')
            ...
            <li class="menu-item " id="student">
                <a href="{{ url('/admin/student') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-box"></i>
                    <div data-i18n="Analytics">Data Mahasiswa</div>
                </a>
            </li>
            <li class="menu-item " id="major">
                <a href="{{ url('/admin/major') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-box"></i>
            ...
            <li class="menu-item " id="journal">
                <a href="{{ url('/admin/journal') }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">Data Jurnal</div>
                </a>
            </li>
            <li class="menu-item " id="theses">
                <a href="{{ url('/admin/theses') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-file-find"></i>
